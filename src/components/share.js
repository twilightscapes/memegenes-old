...
<div className="sharebutts" style={{   background: 'transparent',
  ...
  margin:'0 auto',}}>
   {/* Sharingbutton Facebook */}
        <a className="resp-sharing-button__link" href="https://facebook.com/sharer/sharer.php?u=http%3A%2F%2Frackhouse.netlify.app" target="_blank" rel="noreferrer" aria-label="Facebook">
