...
<div className='player-wrapper' style={{position:'relative', width:'100vw',  top:'', zIndex:'', height:'', overflow:'hidden' }}>
...
<div className="post-card1" style={{display:'block', justifyContent:'', maxWidth:'60vw', margin:'', flexDirection:'', border:'0px solid red', position:'relative', top:'0', height:''}}>
    ...
    <p className="headline" style={{fontSize:'90%', color:'#fff', fontWeight:'bold', textAlign:'right', width:'350px', marginRight:'15px'}}>Paste YouTube Link:
</p>
<input
          id=""
          type="text"
...
<div className="" style={{display:'block', justifyContent:'', maxWidth:'60vw', margin:'', flexDirection:'', border:'0px solid red', position:'relative', top:'0', height:'100vh'}}>
